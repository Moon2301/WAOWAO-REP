...
const VIDEO_TYPES = new Set<TaskType>([
  ...
  TASK_TYPE.LIP_SYNC,
  TASK_TYPE.VIDEO_CHARACTER_SWAP,
  TASK_TYPE.VIDEO_CHARACTER_SWAP_CHUNK,
  TASK_TYPE.VIDEO_CHARACTER_SWAP_MERGE,
  TASK_TYPE.VIDEO_FRAME_EXTRACT,
  TASK_TYPE.VIDEO_FRAME_CLASSIFY,
  TASK_TYPE.VIDEO_FRAME_PROCESS,
  TASK_TYPE.VIDEO_FRAME_MERGE,
])
